      ...
      <main>
        <section className={styles.hero}>
          <div className={styles.inner}>
            ...
            <div className={styles.actions}>
              ...
              <Link className={styles.button} to="pathname:///guest-documentation.pdf">
                Download PDF
              </Link>
            </div>
          </div>
        ...
        <section className={styles.below} aria-label="Quick links">
          <div className={styles.quickLinks}>
            <Link className={styles.quickLink} to="/docs/documentation/video/lowering_screen">
              <strong>Video Guides</strong>
              <p>Screen, projector, rear TV, and input instructions.</p>
            </Link>
            <Link className={styles.quickLink} to="/docs/documentation/audio/turning_sound_system_on">
